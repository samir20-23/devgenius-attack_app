@echo off
:: DevGenius - Wi-Fi Attack Tool - Developed By TechnicalUserX
:: Please refer to https://github.com/samir20-23/ for more projects
...
if not exist Source_Code\createPasswords\password.txt (
   if not exist Source_Code\createPasswords\wordlist.txt (
    set wordlist_file=not_defined
) else (
    set wordlist_file=Source_Code\createPasswords\wordlist.txt
)
) else (
    set wordlist_file=Source_Code\createPasswords\password.txt
)
